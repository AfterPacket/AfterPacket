...
**Traps by adhesion** — attackers stick to it.
...
#### [Vexor](https://github.com/AfterPacket/vexor)
...
A full OWASP GenAI Top 10 red-teaming platform. Multi-provider support,
automated jailbreak testing, mutation engines, PromptFoo imports, and
...
#### [Pow-Shield](https://github.com/AfterPacket/pow-shield-php)
...
A modern proof-of-work framework for PHP and WordPress. Adaptive SHA-256
puzzles, no CAPTCHA, no JavaScript fingerprinting, no third-party services.
...
aggregating live data from IODA, GDELT, Cloudflare Radar, and RIPE Atlas.
Built for correlating outages against real-world events.
...
An open-source OSINT platform: username enumeration, face correlation, breach
intelligence, metadata extraction, and multi-provider searching.
...
#### [Secure Blog CMS](https://github.com/AfterPacket/secure-blog-cms)
...
A flat-file PHP blog CMS with no database. Argon2id sessions, CSP, 2FA,
alerting, and a security-first architecture.
